...
import { ConversationCoordinatorProvider } from "./components/ConversationCoordinatorProvider";
        ...
        <header className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="text-sm text-zinc-500">
              Connect multiple voice agents with turn-taking and shared context
            </p>
          </div>
          <button
            onClick={addAgent}
